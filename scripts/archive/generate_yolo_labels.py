"""
ARCHIVED - LEGACY (Stanford Cars 11-class schema, superseded by the 7-class
vehicle schema in configs/vehicle_7class.yaml). Converts devkit/cars_train_annos.mat
into YOLO labels. Requires the Stanford devkit, which is gitignored.
"""

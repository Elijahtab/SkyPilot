"""
ARCHIVED - DEAD PATHS. Targets kaggle_dataset/{images,labels}/ and a hardcoded
~/.cache/kagglehub/... path. The dataset was restructured to
kaggle_dataset/{train,valid,test}/ by download_kaggle.py, so this no longer runs.
Kept only as a record of the original layout.
"""
